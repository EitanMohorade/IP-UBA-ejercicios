...
print(contar_lineas("Ejercicios\Python\Guia_8\ejer_19.txt"))
print(existe_palabra("Ejercicios\Python\Guia_8\ejer_19.txt", "hola buenas"))
print(cantidad_de_apariciones("Ejercicios\Python\Guia_8\ejer_19.txt", "hola buenas"))
